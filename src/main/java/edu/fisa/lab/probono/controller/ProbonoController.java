...
public class ProbonoController {
	...
	public ModelAndView activistAll() throws Exception {
		...
		md.addObject("activistAll", all);//setAttribute("activistAll", all); //all -> activistAll 변수로 저장
		md.setViewName("activist/activistList");  //  어떤뷰로 갈건지,, 경로 -> /WEB-INF/activist/activistList.jsp
